...
import {
  ...
  useWaitForDOMRef,
  useWindow
} from "./chunk-XYFCRPYA.js";
import {
  Row_default
} from "./chunk-GMK5J7MR.js";
import {
  Button_default as Button_default2
} from "./chunk-JM2YQB5Q.js";
import {
  Anchor_default,
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react8.useReducer)((state) => !state, false);
  return dispatch;
}
...
var Switch = React62.forwardRef((props, ref) => (0, import_jsx_runtime60.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = React77.forwardRef(({
  ...
  const renderBackdrop = (0, import_react32.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
...
var Overlay = React82.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react35.useState)(!props.show);
...
var PopoverHeader = React83.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Overlay2 = React88.forwardRef(({
  ...
  const popperRef = (0, import_react37.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react37.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react38.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react38.useRef)("");
  ...
  const handleShow = (0, import_react38.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react38.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react38.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react38.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react38.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react38.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react38.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime90.jsxs)(import_jsx_runtime89.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react38.cloneElement)(children, triggerProps), (0, import_jsx_runtime88.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React90.forwardRef(({
    children,
    ...props
...
var ProgressBar = React94.forwardRef(({
  ...
  return (0, import_jsx_runtime96.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react39.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react40.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react41.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react41.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React108.forwardRef(({
  ...
  const context5 = (0, import_react42.useContext)(ToastContext_default);
...
var Toast = React110.forwardRef(({
  ...
  const delayRef = (0, import_react43.useRef)(delay);
  const onCloseRef = (0, import_react43.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react43.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react43.useMemo)(() => ({
    onClose
  }), [onClose]);
